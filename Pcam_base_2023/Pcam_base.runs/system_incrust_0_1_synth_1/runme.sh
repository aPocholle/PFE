...
HD_PWD='F:/PFE/Pcam_base_2023/Pcam_base.runs/system_incrust_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_incrust_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_incrust_0_1.tcl
