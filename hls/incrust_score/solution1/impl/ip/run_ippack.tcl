...
set Library     "hls"
set IPName      "incrust_score"
set Version     "1.1"
set DisplayName "Incrust_score"
set Revision    "1"
...
set sdx_kernel_name "incrust_score"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "F:/PFE/hls/incrust_score/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {incrust_score_im_bkb
...
## Variables
set Top "incrust_score"
set TopNoPrefix "incrust_score"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 start_x W 0x0 "Data signal of start_x" {{0 32 start_x W 0 "Bit 31 to 0 Data signal of start_x"}}} {0x18 start_y W 0x0 "Data signal of start_y" {{0 32 start_y W 0 "Bit 31 to 0 Data signal of start_y"}}} {0x20 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 Data signal of mode"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
