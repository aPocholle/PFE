...
// ==============================================================
#ifndef __incrust_score_im_cud_H__
#define __incrust_score_im_cud_H__
...
struct incrust_score_im_cud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(incrust_score_im_cud_ram) {
        ...
        for (unsigned i = 1101; i < 1125 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1151; i < 1175 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1175; i < 1181 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1201; i < 1225 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1401; i < 1419 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1419; i < 1425 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1425; i < 1449 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1449] = "0b00000000000000000";
        ram[1450] = "0b00000000000000000";
        for (unsigned i = 1451; i < 1469 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1469; i < 1475 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1475; i < 1499 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1499] = "0b00000000000000000";
        ram[1500] = "0b00000000000000000";
        for (unsigned i = 1501; i < 1519 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1519; i < 1525 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1525; i < 1549 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1572; i < 1599 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1622; i < 1649 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1672; i < 1699 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1722; i < 1749 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1772; i < 1799 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1822; i < 1849 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1866; i < 1884 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1901; i < 1916 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1916; i < 1934 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1934; i < 1949 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1949] = "0b00000000000000000";
        ram[1950] = "0b00000000000000000";
        for (unsigned i = 1951; i < 1966 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1966; i < 1984 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1984; i < 1999 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
...
SC_MODULE(incrust_score_im_cud) {
...
incrust_score_im_cud_ram* meminst;


SC_CTOR(incrust_score_im_cud) {
meminst = new incrust_score_im_cud_ram("incrust_score_im_cud_ram");
