...
// ==============================================================
#ifndef __incrust_score_im_eOg_H__
#define __incrust_score_im_eOg_H__
...
struct incrust_score_im_eOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(incrust_score_im_eOg_ram) {
        ...
        for (unsigned i = 501; i < 549 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 651; i < 669 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 669; i < 681 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 681; i < 699 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 801; i < 816 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 816; i < 822 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 851; i < 866 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 866; i < 872 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 901; i < 916 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 951; i < 966 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 966; i < 972 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1001; i < 1016 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1051; i < 1066 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1066; i < 1072 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1101; i < 1116 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1116; i < 1122 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1122; i < 1128 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1128; i < 1134 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1134; i < 1149 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1149] = "0b00000000000000000";
        ram[1150] = "0b00000000000000000";
        for (unsigned i = 1151; i < 1166 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1178; i < 1184 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1201; i < 1216 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1216; i < 1222 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1222; i < 1228 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1228; i < 1234 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1234; i < 1249 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1249] = "0b00000000000000000";
        ram[1250] = "0b00000000000000000";
        for (unsigned i = 1251; i < 1266 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1266; i < 1272 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1301; i < 1316 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1316; i < 1322 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1351; i < 1366 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1366; i < 1372 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1401; i < 1416 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1416; i < 1422 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1451; i < 1466 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1501; i < 1516 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1551; i < 1566 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1566; i < 1572 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1601; i < 1616 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1616; i < 1622 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1651; i < 1666 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1851; i < 1866 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1866; i < 1872 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 1884; i < 1899 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 2001; i < 2019 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 2019; i < 2031 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 2031; i < 2049 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
...
SC_MODULE(incrust_score_im_eOg) {
...
incrust_score_im_eOg_ram* meminst;


SC_CTOR(incrust_score_im_eOg) {
meminst = new incrust_score_im_eOg_ram("incrust_score_im_eOg_ram");
