...
// ==============================================================
#ifndef __incrust_score_im_bkb_H__
#define __incrust_score_im_bkb_H__
...
struct incrust_score_im_bkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(incrust_score_im_bkb_ram) {
        ...
        for (unsigned i = 666; i < 678 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        ...
        for (unsigned i = 716; i < 728 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 728; i < 749 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 766; i < 778 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 778; i < 799 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[799] = "0b00000000000000000";
        ram[800] = "0b00000000000000000";
        for (unsigned i = 801; i < 822 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 822; i < 828 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 828; i < 849 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 878; i < 899 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[899] = "0b00000000000000000";
        ram[900] = "0b00000000000000000";
        for (unsigned i = 901; i < 922 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 922; i < 928 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 928; i < 949 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[949] = "0b00000000000000000";
        ram[950] = "0b00000000000000000";
        for (unsigned i = 951; i < 972 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 972; i < 978 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 978; i < 999 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1028; i < 1049 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ram[1049] = "0b00000000000000000";
        ram[1050] = "0b00000000000000000";
        for (unsigned i = 1051; i < 1072 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        for (unsigned i = 1072; i < 1078 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1078; i < 1099 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1122; i < 1128 ; i = i + 1) {
            ram[i] = "0b00000000000000000";
        }
        for (unsigned i = 1128; i < 1149 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
        ...
        for (unsigned i = 1178; i < 1199 ; i = i + 1) {
            ram[i] = "0b10111111101111111";
        }
...
SC_MODULE(incrust_score_im_bkb) {
...
incrust_score_im_bkb_ram* meminst;


SC_CTOR(incrust_score_im_bkb) {
meminst = new incrust_score_im_bkb_ram("incrust_score_im_bkb_ram");
