...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("start_x", 32, hls_in, 16, "ap_none", "in_data", 1),
	Port_Property("start_y", 32, hls_in, 17, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "incrust_bar";
