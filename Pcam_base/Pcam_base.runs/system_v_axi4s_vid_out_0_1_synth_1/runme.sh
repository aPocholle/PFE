...
HD_PWD='F:/vivado_proj/Pcam_Adapter_base/Pcam_Adapter_base.runs/system_v_axi4s_vid_out_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_axi4s_vid_out_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_axi4s_vid_out_0_1.tcl
