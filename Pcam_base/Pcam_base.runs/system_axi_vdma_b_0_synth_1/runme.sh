...
HD_PWD='C:/Users/Juliette GAGNEPAIN/Downloads/ZedBoard-FMC-Pcam-Adapter-Dual-Camera-2018.2-1/vivado_proj/ZedBoard-FMC-Pcam-Adapter-DEMO.runs/system_axi_vdma_b_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_vdma_b_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_vdma_b_0.tcl
